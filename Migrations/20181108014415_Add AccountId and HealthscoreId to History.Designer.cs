...
namespace Bolstra.Migrations
{
    ...
    [Migration("20181108014415_Add AccountId and HealthscoreId to History")]
    partial class AddAccountIdandHealthscoreIdtoHistory
    {
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.Account", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.AccountCategory", "AccountPriority")
                        .WithMany()
                        .HasForeignKey("AccountPriorityId")
                        .HasConstraintName("fk_account_account_category_account_priority_id")
                        .OnDelete(DeleteBehavior.Cascade);
