...
namespace Bolstra.Migrations
{
    ...
    [Migration("20190717181040_FixUpdateAccountArrMrrBug")]
    partial class FixUpdateAccountArrMrrBug
    {
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.NotificationRecipient", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.AccountUser", "User")
                        .WithMany()
                        .HasForeignKey("CompanyUserId")
                        .HasConstraintName("fk_notification_recipient_account_user_company_user_id")
                        .OnDelete(DeleteBehavior.Cascade);
