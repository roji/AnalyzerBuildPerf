...
namespace Bolstra.Migrations
{
    ...
    [Migration("20190502171340_ModifyAccountHealthscoreHealthscoreFkey")]
    partial class ModifyAccountHealthscoreHealthscoreFkey
    {
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AccountAttribute", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_account_attribute_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_account_attribute_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AccountCategory", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_account_category_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_account_category_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AccountCollection", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_account_collection_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_account_collection_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AdminAttachment", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_attachments_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_attachments_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AdminLayoutSection", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.AdminLayout", "Layout")
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.Note", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_notes_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_notes_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.Appointment", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_appointment_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_appointment_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.AppointmentAssignment", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_appointment_assignment_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_appointment_assignment_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.AppointmentRelation", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_appointment_relation_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_appointment_relation_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.Stopwatch", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_stopwatch_user_created_by")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bolstra.Api.Models.Admin.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("LastModifiedBy")
                        .HasConstraintName("fk_stopwatch_user_last_modified_by")
                        .OnDelete(DeleteBehavior.Cascade);
                });
