...
namespace Bolstra.Migrations
{
    ...
    [Migration("20190827182051_ModifyAccountHealthscoreTrigger")]
    partial class ModifyAccountHealthscoreTrigger
    {
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.Account", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SalesforceId")
                        .IsUnique()
                        .HasName("ix_account_company_id_salesforce_id");
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Admin.AccountUser", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SalesforceId")
                        .IsUnique()
                        .HasName("ix_account_user_company_id_salesforce_id");
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.ActivityLabel", b =>
                {
                    ...
                    b.HasIndex("LabelId")
                        .HasName("ix_activity_label_label_id");
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.Contract", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SalesforceId")
                        .IsUnique()
                        .HasName("ix_contract_company_id_salesforce_id");
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.ActivityLabel", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Engage.Label", "Label")
                        .WithMany()
                        .HasForeignKey("LabelId")
                        .HasConstraintName("fk_activity_label_label_label_id")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Bolstra.Api.Models.Engage.TimeEntry", b =>
                {
                    ...
                    b.HasOne("Bolstra.Api.Models.Admin.CompanyUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_time_entry_company_user_user_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
